...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		...
		local fs = "image[0.75,0.5;2.2,2.2;" .. core.formspec_escape(logofile) .. "]" ..
			...
			"button[0.5,2;2.5,2;label_button;" .. "Garud Client" .. "]" ..
			"button[0.75,2.75;2,2;homepage;GitHub]" ..
			"tablecolumns[color;text]" ..
			"tableoptions[background=#00000000;highlight=#00000000;border=false]" ..
			"table[3.5,-0.25;8.5,6.05;list_credits;" ..
			"#FFFF00," .. fgettext("Developers [Garud Client]") .. ",," ..
			buildCreditList(client_developers) .. ",,," ..
			"#FFFF00," .. fgettext("Credits") .. ",," ..
			buildCreditList(client_credits) .. ",,," ..
			"#FFFF00," .. fgettext("Core Developers [Minetest]") .. ",," ..
			buildCreditList(core_developers) .. ",,," ..
			"#FFFF00," .. fgettext("Active Contributors [Minetest]") .. ",," ..
			buildCreditList(active_contributors) .. ",,," ..
			"#FFFF00," .. fgettext("Previous Core Developers [Minetest]") ..",," ..
			buildCreditList(previous_core_developers) .. ",,," ..
			"#FFFF00," .. fgettext("Previous Contributors [Minetest]") .. ",," ..
	...
	cbf_button_handler = function(this, fields, name, tabdata)
		if fields.homepage then
			core.open_url("https://github.com/astra0081X/Garud-Client")
		end
