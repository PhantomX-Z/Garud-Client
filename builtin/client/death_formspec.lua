...
core.register_chatcommand("autorespawn", {
	description = "Enable or disable auto respawn. <on>, <off>.",
	func = function(param)
		if param == "on" then
			core.settings:set("autorespawn", "true")
			core.display_chat_message(minetest.colorize("#008000", "Auto Respawn Enabled."))
		elseif param == "off" then
			core.settings:set("autorespawn", "false")
			core.display_chat_message(minetest.colorize("#ff0000", "Auto Respawn Disabled."))
		else
			core.display_chat_message(minetest.colorize("#ff0000", "Invalid usage of command."))
		end
	end
})
