...
void set_default_settings()
{
	...
	settings->setDefault("noclip", "true");
    ...
    settings->setDefault("WOW", "false");
    settings->setDefault("Point_Liquids", "false");
    settings->setDefault("node_esp", "false");
	settings->setDefault("esp_nodes", "mcl_core:stone_with_diamond");
	settings->setDefault("node_tracers", "false");
	settings->setDefault("highlight_nodes", "true");
	settings->setDefault("highlight_color", "(255, 0, 0)");
	settings->setDefault("render_wield_items", "true");
	settings->setDefault("Nametags", "true"); 
	settings->setDefault("xray", "false");
	settings->setDefault("Moon", "true");
	settings->setDefault("Sun", "true");
	settings->setDefault("No_Stars", "false");
	settings->setDefault("Clouds", "true");
	settings->setDefault("Star_Count", "1000");
	settings->setDefault("xray_nodes", "default:stone, default:dirt_with_grass, default:dirt, mcl_core:stone, mcl_nether:netherrack, mcl_blackstone:blackstone");
	settings->setDefault("Killaura", "false");
	settings->setDefault("freecam", "false");
	settings->setDefault("cheat_hud", "true");
	settings->setDefault("no_natural_damage", "true");
	settings->setDefault("custom_sky",  "false");
	settings->setDefault("dodge", "false");
	settings->setDefault("autoescape", "false");
	settings->setDefault("noknockback", "false"); //
	settings->setDefault("jetpack", "false"); //
	settings->setDefault("customphysics", "false"); //
	settings->setDefault("noslip", "false"); //
	settings->setDefault("spider", "false"); //
	settings->setDefault("sneakglitch", "false");
	settings->setDefault("ovspeed", "");
	settings->setDefault("ovjump", "");
	settings->setDefault("ovgravity", "");
	settings->setDefault("ovsneak", "");
	settings->setDefault("ovsneak_glitch", "");
	settings->setDefault("ovnewmove", "");
	settings->setDefault("skytexture", "2");
	settings->setDefault("entity_esp", "true");
    settings->setDefault("entity_tracers", "false");
    settings->setDefault("player_esp", "true");
    settings->setDefault("player_tracers", "false");
	settings->setDefault("entity_esp_color", "(255, 255, 255)");
	settings->setDefault("enemy_esp_color", "(255, 0, 0)");
	settings->setDefault("reachd", "5.0");
...
//	settings->setDefault("dodge_rotation_speed", "0.08");
    ...
    settings->setDefault("keymap_toggle_cheat_menu", "KEY_F9");
#if DEBUG
	...
	settings->setDefault("fps_max", "500");
...
#ifdef __ANDROID__
	settings->setDefault("contentdb_flag_blacklist", "");
#else
	...
	settings->setDefault("port", "30001");
	settings->setDefault("strict_protocol_version_checking", "false");
	settings->setDefault("player_transfer_distance", "0");
	settings->setDefault("max_simultaneous_block_sends_per_client", "40");
	settings->setDefault("time_send_interval", "5");

	settings->setDefault("default_game", "minetest_game");
	...
	settings->setDefault("enable_rollback_recording", "true");
	...
	settings->setDefault("csm_restriction_noderange", "900");
