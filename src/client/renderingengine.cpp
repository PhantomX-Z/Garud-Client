...
/*
	...
	if (texture == nullptr) {
		video::ITexture *background_image = tsrc->getTexture("menu_bg.png");
...
{
	core->draw(skycolor, show_hud, show_minimap, draw_wield_tool, draw_crosshair, node_esp, node_tracers, entity_esp, entity_tracers, player_esp, player_tracers);
}
