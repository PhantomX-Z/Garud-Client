...
void GUIFormSpecMenu::parseRectangleOutline(parserData* data, const std::string &element)
{
        ...
        ((parts.size() > 3) && (m_formspec_version > FORMSPEC_API_VERSION)))
    {
        ...
        GUIRectangleOutline *e = new GUIRectangleOutline(
    ...
    errorstream << "Invalid RectangleOutline element(" << parts.size() << "): '" << element << "'" << std::endl;
}
...
void GUIFormSpecMenu::parseElement(parserData* data, const std::string &element)
{
	...
	if (type == "outline") {
		GUIFormSpecMenu::parseRectangleOutline(data,description);
		return;
	}
